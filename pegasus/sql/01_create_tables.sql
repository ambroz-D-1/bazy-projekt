...
CREATE TABLE USER_STATUSES (
    ...
    LABEL_PL     VARCHAR2(100) NOT NULL,
    LABEL_EN     VARCHAR2(100) NOT NULL,
    DESCRIPTION  VARCHAR2(300),
    IS_ACTIVE    NUMBER(1) DEFAULT 1 CHECK (IS_ACTIVE IN (0, 1))
);

INSERT INTO USER_STATUSES (STATUS_CODE, LABEL_PL, LABEL_EN, DESCRIPTION, IS_ACTIVE)
VALUES ('ACTIVE',    'Aktywny',     'Active',    'Konto aktywne i w pelni funkcjonalne',                    1);
INSERT INTO USER_STATUSES (STATUS_CODE, LABEL_PL, LABEL_EN, DESCRIPTION, IS_ACTIVE)
VALUES ('SUSPENDED', 'Zawieszony',  'Suspended', 'Konto tymczasowo zawieszone przez administratora',        1);
INSERT INTO USER_STATUSES (STATUS_CODE, LABEL_PL, LABEL_EN, DESCRIPTION, IS_ACTIVE)
VALUES ('DELETED',   'Usuniety',    'Deleted',   'Konto oznaczone jako usuniete (soft delete)',              0);
INSERT INTO USER_STATUSES (STATUS_CODE, LABEL_PL, LABEL_EN, DESCRIPTION, IS_ACTIVE)
VALUES ('WATCHED',   'Obserwowany', 'Watched',   'Konto pod szczegolna obserwacja moderatora',              1);
COMMIT;
